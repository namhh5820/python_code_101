#Tag cho instance để nhằm lọc ra những instance cần thực hiện công việc tối ưu
#Key: Enviroment_Auto
#Value: true

#Trước khi import code, hãy tạo Environment variables trên Lambada như sau:
#Key: Enviroment_Auto
#Value: true
...
webhook_url = "https://hooks.slack.com/services/T01H4J6EGGN/B01J15NP6E4/XXXXXXXXXXXXXXX"
